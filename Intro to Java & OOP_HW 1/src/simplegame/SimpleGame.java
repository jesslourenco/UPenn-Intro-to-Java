...
public class SimpleGame {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Which game you want to play? Type '1' for Time Conversion or type '2' for Digits Sum: ");
		Scanner sc = new Scanner(System.in);
		int option = sc.nextInt();
		
		if (option == 1) {
			System.out.println("Please input seconds for conversion: ");
			...
			System.out.println("Please input number for sum: ");
			int input = sc.nextInt();
			int totalSum = game.digitsSum(input); 
